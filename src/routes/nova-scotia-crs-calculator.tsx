...
import pageHtml from "@/content/nova_scotia_crs_calculator.html?raw";
import pageJs from "@/content/nova_scotia_crs_calculator.pagejs.txt?raw";

export const Route = createFileRoute("/nova-scotia-crs-calculator")({
  head: () => ({
    meta: [
      {
