...
export const Route = createFileRoute("/ielts-crs-calculator")({
  head: () => ({
    meta: [
      {
            "title": "IELTS to CRS Points Calculator 2026 \u2013 Express Entry Language Score Converter"
      },
      {
            "name": "description",
            "content": "Use this free IELTS to CRS points calculator to convert IELTS bands into CLB levels and estimate Express Entry CRS language points for Canada PR in 2026. Mobile-friendly, fast and updated."
      },
      {
            "name": "robots",
      ...
      {
            "property": "og:title",
            "content": "IELTS to CRS Points Calculator 2026 \u2013 Express Entry Language Score Converter"
      },
      {
            "property": "og:description",
            "content": "Convert IELTS scores to CLB and estimate CRS language points for Canada Express Entry."
      },
      {
            "property": "og:url",
      ...
      },
      {
            ...
            "content": "Free IELTS to CRS points calculator updated for Canada Express Entry 2026."
      },
      {
            "name": "twitter:image",
            "content": "https://crscalculator.site/og-image.jpg"
